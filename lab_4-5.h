...
void number_1g() {
    ...
    printf("Ïîëó÷èâøàÿñÿ ïîñëåäîâàòåëüíîñòü: \n");
...
void number_2a() {
    ...
    printf("Ââåäèòå ïîñëåäîâàòåëüíîñòü: \n");
    fgets(str, sizeof(str), stdin);
    printf("Ñîçäàííàÿ ïîñëåäîâàòåëüíîñòü: \n");
    if (strchr(str, '$'))
    {
        ...
        printf("Ïîñëåäîâàòåëüíîñòü íå çàêàí÷èâàåòñÿ '$'");
    return 0;
}
...
void number_2b() {
    ...
    if (strchr(str, '$')) {
        ...
        printf("Ïîñëåäîâàòåëüíîñòü íå çàêàí÷èâàåòñÿ a '$'!");
    return 0;
}
